...
handles.y_n = str2double(get(hObject,'String')); 
guidata(hObject,handles);
...
function y_n2_Callback(hObject, eventdata, handles)
% hObject    handle to y_n2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of y_n2 as text
%        str2double(get(hObject,'String')) returns contents of y_n2 as a double
handles.y_n2 = str2double(get(hObject,'String'));
guidata(hObject,handles);

% --- Executes during object creation, after setting all properties.
function y_n2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to y_n2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function y_n1_Callback(hObject, eventdata, handles)
% hObject    handle to y_n1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of y_n1 as text
%        str2double(get(hObject,'String')) returns contents of y_n1 as a double
handles.y_n1 = str2double(get(hObject,'String'));
guidata(hObject,handles);

% --- Executes during object creation, after setting all properties.
function y_n1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to y_n1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function u_m1_Callback(hObject, eventdata, handles)
% hObject    handle to u_m1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of u_m1 as text
%        str2double(get(hObject,'String')) returns contents of u_m1 as a double
handles.u_m1 = str2double(get(hObject,'String'));
guidata(hObject,handles);

% --- Executes during object creation, after setting all properties.
function u_m1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to u_m1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function u_m_Callback(hObject, eventdata, handles)
% hObject    handle to u_m (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of u_m as text
%        str2double(get(hObject,'String')) returns contents of u_m as a double
handles.u_m = str2double(get(hObject,'String')); 
guidata(hObject,handles);
% --- Executes during object creation, after setting all properties.
function u_m_CreateFcn(hObject, eventdata, handles)
% hObject    handle to u_m (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function u_m2_Callback(hObject, eventdata, handles)
% hObject    handle to u_m2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of u_m2 as text
%        str2double(get(hObject,'String')) returns contents of u_m2 as a double
handles.u_m2 = str2double(get(hObject,'String')); 
guidata(hObject,handles);

% --- Executes during object creation, after setting all properties.
function u_m2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to u_m2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
